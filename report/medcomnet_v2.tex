...
\title{\huge Enabling RAN Slicing Through Carrier Aggregation in \gls{mmwave} Cellular Networks} % temp
\author[1]{\Large Matteo Pagin}
\affil[1]{Depeartment of Information Engineering, University of Padova}
